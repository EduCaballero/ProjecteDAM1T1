...
function altaNuevoConcierto($day, $month, $year, $time, $genre, $pago) {
    $con = connect("proyecto");
    $select = "insert into concierto(dia, hora, pago, local, genero, asignado) values('$year-$month-$day','$time','$pago',1,$genre,0)";
