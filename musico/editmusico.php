                                ...
                                <form id="musico-profile" class="form-profile" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <label></label><div class="input-wrap">
                                            <input type="submit" name="update" value="Modificar" class="btn btn-submit"/>
                                            <input type="reset" value="Limpiar" class="btn btn-reset">
                                        <form action="" method="POST"><input type="submit" name="delete" value="Borrar Cuenta" class="btn btn-reset"></form></div>
                                    </div>
                                </form>
                            </div>
                        </div>
