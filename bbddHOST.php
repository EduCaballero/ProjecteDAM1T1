...
function altaUsuario($email, $pass, $user, $ciudad, $telefono, $web, $nombre) {
    ...
    $web = ($web == '' ? "NULL" : "'" . $web . "'");
    $confirmcode = rand();//creamos un codigo
    ...
    enviarMail($email,$confirmcode);//llamamos a la funcion enviarMail que envia el mail
...
function enviarMail($email,$confirmcode){
   ...
   error_reporting( E_ALL & ~( E_NOTICE | E_STRICT | E_DEPRECATED ) ); 
    ...
    $to = $email; 
    $from = 'noreplay@concertpush.com'; 
    $host = 'smtp.concertpush.com'; 
    $username = 'noreplay@concertpush.com'; 
    $password = 'Alexangeledu12'; 
    $subject = 'Confirma tu cuenta de concertpush.com'; 
    $body = "Confirma tu cuenta de concertpush: http://www.concertpush.com/emailconfirm.php?mail=$email&code=$confirmcode"; 
...
function verificarCodigo($mail) {
    $con = connect("db4959381_db4959381_proyecto");
