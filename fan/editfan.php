...
if (isset($_SESSION["id"])) {
    if ($_SESSION["tipo"] == "F") {
        if (isset($_POST["update"])) {
            ...
            updateFanProfile($_SESSION["id"], $_POST["name"], $_POST["surnames"], $_POST["city"], $_POST["tlf"], $_POST["web"]);
        ...
        $fanData = mysqli_fetch_array(getFanDataById($_SESSION["id"]));
        ?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <script src="../js/src/fan-profile.js"></script>
            ...
            <body>
                ...
                <div id="container">
                    ...
                    <div id="main">
                        ...
                        require_once '../includes/delete-user-modal.php';
                        if(isset($_POST["delete"])){
                            echo "<script>enableModal('#delete-user-modal')</script>";
                        }
                        ?>
                        <div id="form-container" class="content">
                            <div class="content-container">
                                <h2><span class="fa fa-pencil"></span>Información personal</h2>
                                <form id="fan-profile" class="form-profile" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <label>Apellidos</label><div class="input-wrap">
                                            <input type="text" name="surnames" value="<?php echo $fanData["apellidos"] ?>"></div>
                                    </div>
                                    <div class="form-row">
                                        <label>Provincia</label><div class="input-wrap">
                                            <select class="provincia" name="province">
                                                ...
                                                $provFan = getProvIdByMunicipioId($userData["ciudad"]);
                                    ...
                                    <div class="form-row">
                                        <label>Municipio</label><div class="input-wrap">
                                            <select class="ciudad" name="city">
                                                <?php
                                                $municipios = getMunicipiosByProvId($provFan);
                                    ...
                                    <div class="form-row">
                                        <label></label><div class="input-wrap">
                                            <input type="submit" name="update" value="Modificar" class="btn btn-submit"/><input type="reset" value="Limpiar" class="btn btn-reset"><form action="" method="POST"><input type="submit" name="delete" value="Borrar Cuenta" class="btn btn-reset"></form></div>
                                    </div>
                                </form>
                            </div>
                        </div>
