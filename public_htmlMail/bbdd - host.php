...
$confirmcode = rand();
    ...
    $mensaje = "Confirma tu cuenta de concertpush: http://www.concertpush.com/emailconfirm.php?nombre=$nombre&codigo_veri=$confirmcode";
...
function MusicoAsignado() {
    ...
    where propuesta.aceptado = 1 and propuesta.musico = 3 
    order by concierto.dia asc limit 7";
    // Ejecutamos la consulta y recogemos el resultado
    $resultado = mysqli_query($con, $select);
    disconnect($con);
