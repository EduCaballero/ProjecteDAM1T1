...
function insertConcierto($dia,$mes,$anyo,$hora,$min) {
    $con = connect("proyecto");
    $insert = "insert into concierto(id_concierto,dia,hora,pago,local,genero,asignado) 
    values(70,'$anyo-$mes-$dia','$hora-$min',12,1,1,0)";
    if (mysqli_query($con, $insert)) {
        echo '
        <div id="done">
            <p><b>Concierto dado de alta</b></p>
        </div>
        ';
    } else {
